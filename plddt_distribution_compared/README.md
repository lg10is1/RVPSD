...
└── results/                   # Generated by the script
    ├── pairwise_wilcox_unbalanced.csv
    ├── pairwise_balanced_all_45.csv
    ├── all_family_stats.csv
    ├── top10_family_stats.csv
    └── ANALYSIS_BILINGUAL_REPORT.txt
figures/
├── single_family/             # Single-family density plots
├── pairwise_unbalanced/       # 45 unbalanced density overlays
├── pairwise_balanced/         # 45 balanced 1:1 density overlays
├── significant_pairs/         # Significant pairs only (|r|≥0.3 or p.adj<0.05)
└── overview/                  # Summary figures (violin-boxplot, heatmap, robustness)
```
